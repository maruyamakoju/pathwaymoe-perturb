...
| **MoE / GRN=none** | **0.630** | [0.552, 0.700] |
| **MoE / GRN=random** | **0.623** | [0.539, 0.696] |
| **MoE / GRN=trrust** | **0.627** | [0.545, 0.699] |
| **MoE / GRN=trrust_weighted** | **0.629** | [0.547, 0.700] |
...
|---|---|---|---|---|
| random_vs_none | -0.007 | [-0.015, -0.000] | 0.350 | no |
| trrust_vs_none | -0.002 | [-0.009, +0.004] | 1.000 | no |
| trrust_weighted_vs_none | -0.001 | [-0.006, +0.004] | 1.000 | no |
| coexpr_vs_none | -0.004 | [-0.011, +0.001] | 0.870 | no |
| coexpr_lfc_vs_none | -0.005 | [-0.011, +0.001] | 0.600 | no |
| coexpr_lfc_vs_trrust | -0.002 | [-0.007, +0.001] | 0.944 | no |
| coexpr_lfc_vs_random | +0.002 | [-0.003, +0.007] | 1.000 | no |
| trrust_vs_random | +0.004 | [+0.001, +0.009] | 0.128 | no |
